...
#'@description Generate a tier list from a set of lists of protein groups identified by MaxQuant for cross-list comparisons. Use Max_Venn output as the argument. Calculates sums of redundant Venn table generated by Max_Venn. Individual proteins in each protein group are compared to others; each protein group is treated as a vector of individual string elements for comparisons. Also see \code{\link{Max_Venn}}(IndividualAnalysis = TRUE)
#'@export
